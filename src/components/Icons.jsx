...
// Clean leaf symbol using Material Symbols (font must be available globally)
export const CleanLeafIcon = ({ className = '' }) => (
  <span className={`material-symbols-leaf ${className}`}>energy_savings_leaf</span>
)
